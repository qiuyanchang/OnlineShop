...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="邱衍昌"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="15891588888"/>
		<input type="hidden" name="orderShipping.receiverState" value="福建"/>
		<input type="hidden" name="orderShipping.receiverCity" value="福州"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="闽侯县"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="闽江学院 xxxxxxxxx"/>
</form>
...
<div class="step-tit">
	<h3>收货人信息</h3>
	<div class="extra-r">
		<a href="#none" class="ftx-05" onclick="use_NewConsignee()">收货地址</a>
	</div>
</div>
<div class="step-cont">
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">邱衍昌</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">158****8888</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">福建省闽侯县</div>
						<div class="adr-m" limit="30">闽江学院 xxxxxxxxx</div>
